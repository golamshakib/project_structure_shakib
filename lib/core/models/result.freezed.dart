...
mixin _$Result<T> {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String message, int statusCode, String? details)? failure,
  }) => throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'Result<$T>.failure(message: $message, statusCode: $statusCode, details: $details)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return failure(message, statusCode, details);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return failure?.call(message, statusCode, details);
  }
